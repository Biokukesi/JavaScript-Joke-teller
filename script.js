...
// Paasing our jokes to the voice API

function tellme(joke)
{

    VoiceRSS.speech({
        key: '64eac51be026404ba58d3419837a78c2',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0,
...
{
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Pun,Christmas?blacklistFlags=nsfw,religious,racist,sexist,explicit';
    try
    {
